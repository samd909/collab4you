    ...
    <footer className="bg-bg text-gray-900 w-full border-t border-gray-200 md:fixed md:bottom-0 md:left-0">
      <div className="max-w-7xl mx-auto px-6 py-4 text-center text-sm md:text-base space-y-2">
        ...
        <div className="flex justify-center space-x-4 mb-1">
          <Link to="/privacy" className="text-blue-700 hover:text-blue-800 hover:underline text-sm md:text-base">
            Privacybeleid
          </Link>
          <Link to="/tos" className="text-blue-700 hover:text-blue-800 hover:underline text-sm md:text-base">
